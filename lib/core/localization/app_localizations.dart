...
class AppLocalizations {
  ...
  static const _localizedStrings = {
    'en': {
      ...
      'readiness_hub': 'Readiness hub',
      'active_trips': 'Active trips',
      'completed_trips': 'Completed trips',
      'open_tasks': 'Open tasks',
      'pending_alerts_short': 'Pending alerts',
      ...
      'transfers_progress': 'Transfer readiness',
      'dining_plans': 'Dining plans',
      'dining_progress': 'Dining plan readiness',
      'readiness_overview': 'Readiness overview',
      'overall_readiness': 'Overall readiness',
      'next_step': 'Next up',
      'safety_alerts': 'Safety & travel alerts',
      ...
      'city_tips_hint': 'Local tips to make the most of your stay',
      'travel_timeline': 'Travel timeline',
      'next_trip': 'Next trip',
      'days_to_go': 'days to go',
      'city_focus': 'Top cities',
    ...
    'ar': {
      ...
      'readiness_hub': 'مركز الجاهزية',
      'active_trips': 'رحلات نشطة',
      'completed_trips': 'رحلات مكتملة',
      'open_tasks': 'مهام مفتوحة',
      'pending_alerts_short': 'تنبيهات معلّقة',
      ...
      'arrival_transfers': 'الوصول والتنقلات',
      'transfers_progress': 'جاهزية النقل',
      'dining_plans': 'حجوزات الطعام',
      'dining_progress': 'جاهزية خطط الطعام',
      'readiness_overview': 'نظرة عامة على الجاهزية',
      'overall_readiness': 'الجاهزية الكلية',
      'next_step': 'التالي',
      'safety_alerts': 'تنبيهات السلامة والسفر',
      'acknowledged': 'تم الاطلاع',
      'acknowledge': 'تأكيد الاطلاع',
      'severity_high': 'عالٍ',
      'severity_medium': 'متوسط',
      'severity_low': 'منخفض',
      'local_insights': 'نصائح محلية',
      'no_alerts': 'لا توجد تنبيهات حالياً',
      'city_tips_hint': 'نصائح محلية للاستمتاع بإقامتك',
      'travel_timeline': 'خط سير السفر',
      'next_trip': 'الرحلة القادمة',
      'days_to_go': 'أيام متبقية',
      'city_focus': 'أكثر المدن زيارة',
