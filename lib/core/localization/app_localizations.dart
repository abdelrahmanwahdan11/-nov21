...
class AppLocalizations {
  ...
  static const _localizedValues = <String, Map<String, String>>{
    'en': {
      ...
      'stays': 'stays',
      'catalog_intro': 'Browse curated categories and tags to refine your stay.',
      'view': 'View',
      'flip_insights': 'Flip insights',
      'guest_reviews': 'Guest reviews',
      'gallery': 'Gallery',
      'videos_photos': 'Videos & more photos',
      ...
      'booking_confirmed': 'Reservation saved locally',
      'my_bookings': 'My bookings',
      'trip_manager_subtitle': 'Manage upcoming stays and history',
      'favorites': 'Favorites',
      'favorites_subtitle': 'Shortlist to revisit quickly',
      'no_favorites': 'No favorites yet',
      'add_more_hotels': 'Tap the heart on any hotel to collect it here.',
      'upcoming_trips': 'Upcoming stays',
      'past_trips': 'Past stays',
      'no_upcoming': 'No upcoming stays yet.',
      'no_history': 'History will appear after your stays.',
      'checkedIn': 'Checked-in',
      'completed': 'Completed',
      'cancelled': 'Cancelled',
      'ai_info_title': 'AI insight placeholder',
      'ai_info_desc': 'Soon, AI will summarize highlights for your saved hotels.',
      'reviews': 'Reviews',
      'review_highlight': 'Guests love the calm interiors and concierge speed.',
    },
    'ar': {
      'app_name': 'روميفاي',
      'skip': 'تخطي',
      ...
      'book_now': 'احجز الآن',
      'tags': 'الوسوم',
      'open_catalog': 'فتح الفئات',
      'stays': 'إقامات',
      'catalog_intro': 'تصفح الفئات والوسوم لصقل رحلتك.',
      'view': 'عرض',
      'flip_insights': 'قلب البطاقات للمزيد',
      'guest_reviews': 'آراء النزلاء',
      'gallery': 'المعرض',
      'videos_photos': 'فيديوهات وصور إضافية',
      ...
      'booking_confirmed': 'تم حفظ الحجز محلياً',
      'my_bookings': 'حجوزاتي',
      'trip_manager_subtitle': 'إدارة الإقامات القادمة والسجل',
      'favorites': 'المفضلة',
      'favorites_subtitle': 'قائمة مختصرة للرجوع السريع',
      'no_favorites': 'لا توجد فنادق مفضلة بعد',
      'add_more_hotels': 'اضغط على القلب في أي فندق لجمعه هنا.',
      'upcoming_trips': 'إقامات قادمة',
      'past_trips': 'إقامات سابقة',
      'no_upcoming': 'لا توجد إقامات قادمة حالياً.',
      'no_history': 'سيظهر السجل بعد إقاماتك.',
      'checkedIn': 'تم تسجيل الوصول',
      'completed': 'مكتمل',
      'cancelled': 'ملغي',
      'ai_info_title': 'مساحة مخصصة لذكاء الاصطناعي',
      'ai_info_desc': 'قريباً سيعرض الذكاء الاصطناعي أبرز ما يميز فنادقك المحفوظة.',
      'reviews': 'التقييمات',
      'review_highlight': 'يعجب الضيوف بالمساحات الهادئة وسرعة الاستجابة.',
    },
  };
